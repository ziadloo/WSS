...
namespace JsonRpc
{
    public class Smd
    {
        ...
        [JsonProperty("types")]
		public static ConcurrentDictionary<int, JObject> Types { get; set; }
        [JsonProperty("services")]
		public ConcurrentDictionary<string, SmdService> Services { get; set; }
		...
		public Smd()
	    {
			...
			Services = new ConcurrentDictionary<string, SmdService>();
			Types = new ConcurrentDictionary<int, JObject>();
        ...
        public void AddService(string method, Dictionary<string,Type> parameters)
        {
            ...
            Services.TryAdd(method, newService);
        }
